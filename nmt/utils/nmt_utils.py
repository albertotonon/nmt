...
__all__ = ["decode_and_evaluate", "get_translation", "decode_to_string"]


def decode_to_string(name,
                     model,
                     sess,
                     bpe_delimiter,
                     beam_width,
    ...
    while True:
        try:
            ...
            for sent_id in range(len(nmt_outputs)):
                ...
                # print('translation is a:', type(translation))
                # print('translation is a:', type(translation.decode('utf-8')))
