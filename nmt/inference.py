...
def inference_str(ckpt,
    ...
    infer_model = model_helper.create_infer_model(model_creator, hparams, scope,
                                                  single_cell_fn)
    return single_worker_inference_on_string(infer_model,
                                             ckpt,
                                             input_str,
                                             hparams)


def single_worker_inference_on_string(infer_model,
                                      ckpt,
                                      input_string,
                                      hparams):
    ...
    # Read data
    # infer data is a list of strings
    infer_data = [input_string]
    ...
    with tf.Session(
        ...
        result = nmt_utils.decode_to_string(
            "infer",
            loaded_infer_model,
            sess,
